...
del toddlytic.apk
call "C:\Program Files\Android\android-8.0.0\zipalign" -v 4 c:\Projects\Toddlytic-Mobile-System\platforms\android\app\build\outputs\apk\release\app-release-unsigned.apk toddlytic.apk

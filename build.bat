...
echo cloudbasha
call "C:\Program Files (x86)\Java\jdk1.8.0_162\bin\jarsigner" -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore toddlyticSystem.keystore c:\Projects\Toddlytic-System-Mobile-App-2_0\platforms\android\app\build\outputs\apk\release\app-release-unsigned.apk toddlyticSYSTEMkey
del toddlytic.apk
